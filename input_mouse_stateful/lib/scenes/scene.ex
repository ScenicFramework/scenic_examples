defmodule Example.Scene do
  ...
  def interpret_mouse_event(
        mouse_state(
          last_btn: btn,
          last_btn_time: last_event_time,
          last_btn_state: @button_down,
          in_drag: false
        ) = old_mouse_state,
  ...
  def interpret_mouse_event(
        mouse_state(last_btn: _, last_btn_time: _, last_btn_state: _, in_drag: false) =
          old_mouse_state,
    ...
    mouse_state(old_mouse_state,
      last_btn: btn,
      last_btn_state: @button_down,
      last_btn_time: new_event_time
    )
  end

  # drag start handling
  def interpret_mouse_event(
        mouse_state(last_btn: _, last_btn_time: _, last_btn_state: @button_down, in_drag: false) =
          old_mouse_state,
        {:cursor_pos, {mx, my}},
        scene
      ) do
