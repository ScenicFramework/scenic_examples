defmodule Example.Scene do
  ...
  def demo_line_height(g, x_offset, y_offset) do
    ...
    |> text( "1.5\nABC\nDEF\nGHI", translate: {x_offset+60, y_offset+ 2*@font_size}, line_height: 1.5 )
    |> text( "2\nABC\nDEF\nGHI", translate: {x_offset+120, y_offset+ 2*@font_size}, line_height: 2 )
  end
  ...
  def demo_fonts(g, x_offset, y_offset) do
    ...
    |> text( "Zen Tokyo Zoo", font: :zen_tokyo_zoo, translate: {x_offset, y_offset + 4*@font_size})
  end
  ...
  def demo_fill(g, x_offset, y_offset) do
    ...
    |> text( "{:color, :blue}", fill: {:color, :blue}, translate: {x_offset, y_offset + 2*@font_size})
  end
